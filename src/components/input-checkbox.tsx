    ...
    variants: {
      ...
      variant: {
        ...
        default: `
                ...
                border-green-base hover:border-green-dark hover:bg-green-dark/20 checked:border-green-base checked:bg-green-base group-hover:checked:border-green-base group-hover:checked:bg-green-dark
                `,
      },
      size: {
